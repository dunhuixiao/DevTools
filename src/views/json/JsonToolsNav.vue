<template>
  <div class="nav-container">
    <div class="hero-section">
      ...
      <h1 class="hero-title">JSON 工具</h1>
      <p class="hero-description">
        提供 JSON 格式化、压缩、转义/反转义功能
      </p>
    </div>
...
import { CodeSlashOutline, DocumentTextOutline } from '@vicons/ionicons5'
...
const tools = [
  {
    id: 'json-format',
    name: 'JSON 格式化',
    description: 'JSON 格式化、压缩、转义/反转义功能',
